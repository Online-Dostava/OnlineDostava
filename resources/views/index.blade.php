    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="infood">Informacije</a>
        </li>
...
<form action="loginme" method="post">
              ...
              <div class="text-center mt-2">
                <button class="btn btn-info" name="login">Log in <i class="fas fa-sign-in ml-1"></i></button>
              </div>
            </div>
            <!--Footer-->
  ...
  @csrf
              ...
              <div class="text-center form-sm mt-2">
                <button class="btn btn-info" name ="register">Registriraj se! <i class="fas fa-sign-in ml-1"></i></button>
              </div>
